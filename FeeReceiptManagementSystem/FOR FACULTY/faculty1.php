...
<input type="Checkbox"  id="sub9"  value='<?php echo  $sub9; ?> <?php echo  $sub9c; ?>' />  <?php echo  $sub9;  ?>&nbsp;&nbsp;&nbsp;<?php echo     $sub9c; ?>
<span class="checkmark"></span></label><label class="container">
<input type="Checkbox"  id="sub10" value='<?php echo  $sub10; ?> <?php echo  $sub10c; ?>'/> <?php echo  $sub10; ?>&nbsp;&nbsp;&nbsp;<?php echo  $sub10c; ?>
<span class="checkmark"></span></label><label class="container">
<input type="Checkbox"  id="sub11" value='<?php echo  $sub11; ?> <?php echo  $sub11c; ?>'/> <?php echo  $sub11; ?>&nbsp;&nbsp;&nbsp;<?php echo  $sub11c; ?>
<span class="checkmark"></span></label><label class="container">
<input type="Checkbox"  id="sub12" value='<?php echo  $sub12; ?> <?php echo  $sub12c; ?>'/> <?php echo  $sub12; ?>&nbsp;&nbsp;&nbsp;<?php echo  $sub12c; ?>
<span class="checkmark"></span></label><label class="container">
<input type="Checkbox"  id="sub13" value='<?php echo  $sub13; ?> <?php echo  $sub13c; ?>'/> <?php echo  $sub13; ?>&nbsp;&nbsp;&nbsp;<?php echo  $sub13c; ?>
<span class="checkmark"></span></label><label class="container">
<input type="Checkbox" id="sub14" value='<?php echo  $sub14; ?><?php echo  $sub14c; ?>'/> <?php echo  $sub14; ?>&nbsp;&nbsp;&nbsp;<?php echo   $sub14c; ?>
<span class="checkmark"></span></label><label class="container">
<input type="Checkbox"  id="sub15" value='<?php echo  $sub15; ?><?php echo  $sub15c; ?>'/> <?php echo  $sub15; ?>&nbsp;&nbsp;&nbsp;<?php echo   $sub15c; ?>
<span class="checkmark"></span></label><label class="container">
<input type="Checkbox" id="sub16" value='<?php echo  $sub16; ?> <?php echo  $sub16c; ?>'/> <?php echo  $sub16; ?>&nbsp;&nbsp;&nbsp;<?php echo  $sub16c; ?>
...
<script type='text/javascript'>
    ...
    $("#formid").submit(function(event) {
      ...
      var posting = $.post( url, { name: $('#usn').val(), name2: $('#sem').val(), name3: $('#branch').val(),
	  name4: $('#fname').val(), name5: $('#sec').val(), name6: $('#sid').val(), name7: $('#sub1').val(), name8: $('#sub1c').val()
	  , name9: $('#sub2').val(), name10: $('#sub2c').val(), name11: $('#sub3').val(), name12: $('#sub3c').val(), name13: $('#sub4').val()
	  , name14: $('#sub4c').val(), name15: $('#sub5').val(), name16: $('#sub5c').val(), name17: $('#sub6').val(), name18: $('#sub6c').val()
	  , name19: $('#sub7').val(), name20: $('#sub7c').val(), name21: $('#sub8').val(), name22: $('#sub8c').val()
	  , name23: $('#sub9').val(), name24: $('#sub10').val(), name25: $('#sub11').val(), name26: $('#sub12').val()
	  , name27: $('#sub13').val(), name28: $('#sub14').val(), name29: $('#sub15').val(), name30: $('#sub16').val()
	  , name31: $('#sub17').val(), name32: $('#sub17c').val(), name33: $('#sem1').val(), name34: $('#sub18').val()
	  , name35: $('#sub18c').val(), name36: $('#sem2').val(), name37: $('#sub19').val(), name38: $('#sub19c').val()
	  , name39: $('#sem3').val(), name40: $('#sub20').val(), name41: $('#sub20c').val(), name42: $('#sem4').val()
	  , name43: $('#sub21').val(), name44: $('#sub21c').val(),name45: $('#sem5').val(), name46: $('#sub22').val()
	  , name47: $('#sub22c').val(), name48: $('#sem6').val(),name49: $('#sub23').val(), name50: $('#sub23c').val()
	  , name51: $('#sem7').val(),name52: $('#sub24').val(), name53: $('#sub24c').val(), name54: $('#sem8').val(),
	  name55: $('#recived').val(),name56: $('#uploaded').val()} );
...
<footer class="second">
    <p>&copyVVCE:devloped by DeveloperStudentClubs VVCE</p>
</footer>
</body>
</html>
